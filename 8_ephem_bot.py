...
def city_game(update, context):
    ...
    game_lst: list = [
        ...
        'моздок', 'мончегорск', 'морозовск', 'моршанск', 'мосальск', 'муравленко', 'мураши', 'мурманск', 'муром', 'мценск', 'мыски', 'мытищи', 'мышкин', 'набережные челны', 'навашино', 'наволоки', 'надым', 'назарово', 'назрань', 'называевск', 'нальчик', 'нариманов', 'наро-фоминск', 'нарткала', 'нарьян-мар', 'находка', 'невель', 'невельск', 'невинномысск', 'невьянск', 'нелидово', 'неман', 'нерехта', 'нерчинск', 'нерюнгри', 'нестеров', 'нефтегорск', 'нефтекамск', 'нефтекумск', 'нефтеюганск', 'нея', 'нижневартовск', 'нижнекамск', 'нижнеудинск', 'нижние серги', 'нижний ломов', 'нижний новгород', 'нижний тагил', 'нижняя салда', 'нижняя тура', 'николаевск', 'николаевск-на-амуре', 'никольск', 'никольское', 'новая ладога', 'новая ляля', 'новоалександровск', 'новоалтайск', 'новоаннинский', 'нововоронеж', 'новодвинск', 'новозыбков', 'новокубанск', 'новокузнецк', 'новокуйбышевск', 'новомичуринск', 'новомосковск', 'новопавловск', 'новоржев', 'новороссийск', 'новосибирск', 'новосиль', 'новосокольники', 'новотроицк', 'новоузенск', 'новоульяновск', 'новоуральск', 'новохопёрск', 'новочебоксарск', 'новочеркасск', 'новошахтинск', 'новый оскол', 'новый уренгой', 'ногинск', 'нолинск', 'норильск', 'ноябрьск', 'нурлат', 'нытва', 'нюрба', 'нягань', 'нязепетровск', 'няндома',
        ...
        'туран', 'туринск', 'тутаев', 'тында', 'тырныауз', 'тюкалинск', 'тюмень', 'уварово', 'углегорск', 'углич', 'удачный', 'удомля', 'ужур', 'узловая', 'улан-удэ', 'ульяновск', 'унеча', 'урай', 'урень', 'уржум', 'урус-мартан', 'урюпинск', 'усинск', 'усмань', 'усолье', 'усолье-сибирское', 'уссурийск', 'усть-джегута', 'усть-илимск', 'усть-катав', 'усть-кут', 'усть-лабинск', 'устюжна', 'уфа', 'ухта', 'учалы', 'уяр', 'фатеж', 'феодосия', 'фокино', 'фролово', 'фрязино', 'фурманов', 'хабаровск', 'хадыженск', 'ханты-мансийск', 'харабали', 'харовск', 'хасавюрт', 'хвалынск', 'хилок', 'химки', 'холм', 'холмск', 'хотьково', 'цивильск', 'цимлянск', 'циолковский', 'чадан', 'чайковский', 'чапаевск',
        'чаплыгин', 'чебаркуль', 'чебоксары', 'чегем', 'чекалин', 'челябинск', 'чердынь', 'черемхово', 'черепаново', 'череповец', 'черкесск', 'черноголовка', 'черногорск', 'чернушка', 'черняховск', 'чехов', 'чистополь', 'чита', 'чкаловск', 'чудово', 'чулым', 'чусовой', 'чухлома', 'чёрмоз', 'шагонар', 'шадринск', 'шали', 'шарыпово', 'шарья', 'шатура',
        'шахты', 'шахтёрск', 'шахунья', 'шацк', 'шебекино', 'шелехов', 'шенкурск', 'шилка', 'шимановск', 'шиханы', 'шлиссельбург', 'шумерля', 'шумиха', 'шуя', 'щигры', 'щучье', 'щёкино', 'щёлкино', 'щёлково', 'электрогорск', 'электросталь', 'электроугли', 'элиста', 'энгельс', 'эртиль', 'югорск', 'южа', 'южно-сахалинск', 'южно-сухокумск', 'южноуральск', 'юрга', 'юрьев-польский', 'юрьевец', 'юрюзань', 'юхнов', 'ядрин', 'якутск', 'ялта', 'ялуторовск', 'янаул', 'яранск', 'яровое', 'ярославль', 'ярцево', 'ясногорск', 'ясный', 'яхрома']

    if user_text not in game_lst:
        update.message.reply_text(f'Нет такого города в нашем списке!')
    else:
        next_turn_letter: str = user_text[-1]
        game_lst.remove(user_text)
        answer: list = [i for i in game_lst if i.startswith(next_turn_letter)]
        chosen_city: str = random.choice(answer)
        update.message.reply_text(f'{next_turn_letter}, {chosen_city.title()}, ваш ход')
